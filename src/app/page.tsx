    ...
    <div className="relative isolate">
      ...
      <div className="relative py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          >
            <a
              href="https://www.facebook.com/profile.php?id=61589016029140"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col sm:flex-row items-center justify-center gap-6 bg-gray-800 border border-gray-700 rounded-2xl p-8 hover:bg-gray-700 hover:border-gray-600 transition-all duration-200"
            >
              ...
              <div className="text-center sm:text-left">
                <h3 className="text-xl font-semibold text-white font-serif group-hover:text-gray-200">
                  Follow Case Notes on Facebook
                </h3>
                <p className="mt-2 text-base text-gray-300">
                  Behind-the-scenes insights, case stories, and updates from Insight Investigations.
                </p>
              </div>
            </a>
          </motion.div>
